...
import { 
  Briefcase, Code, Users, ArrowUpRight, ArrowDownRight, 
  Clock, CheckCircle, AlertCircle, User, Target, 
      ...
      <div className="bg-gray-900/95 backdrop-blur-xl border border-white/10 rounded-lg p-4 shadow-xl">
        ...
        {payload.map((entry: any, index: number) => (
          <p key={index} className="text-sm text-white/70">
            {entry.name}: <span className={index === 0 ? "text-yellow-500" : "text-blue-400"}>
              {entry.value}
            </span>
          </p>
        ))}
        ...
        >
          ...
          <div className="relative p-6">
            <div className="flex items-center justify-between mb-6">
              <h3 className="text-lg font-semibold text-white">Projects & Services Overview</h3>
